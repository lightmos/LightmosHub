...
type RestakingPacketData_RestakePacket struct {
	RestakePacket *RestakePacketData `protobuf:"bytes,6,opt,name=restakePacket,proto3,oneof" json:"restakePacket,omitempty"`
}
type RestakingPacketData_UndelegatePacket struct {
	UndelegatePacket *UndelegatePacketData `protobuf:"bytes,7,opt,name=undelegatePacket,proto3,oneof" json:"undelegatePacket,omitempty"`
}
...
func (*UndelegatePacketData) Descriptor() ([]byte, []int) {
	return fileDescriptor_2549f93fea6967e4, []int{12}
}
...
func (*UndelegatePacketAck) Descriptor() ([]byte, []int) {
	return fileDescriptor_2549f93fea6967e4, []int{13}
}
...
var fileDescriptor_2549f93fea6967e4 = []byte{
	...
	,
}
